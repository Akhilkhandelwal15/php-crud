...
<div class="container mt-3" id='formcontainer'>
  ...
  <div style='text-align:center' id='editstudentmessage' class='text-success'></div>
  ...
  <div class="mb-3 mt-3" id="radio-btn">
    ...
    <input id="formtype" type="hidden" name="formtype", value="registration">
      <button class='btn btn-primary' id='backButton'>Back</button>
        <button type="submit" id = "submitbtn1" class="btn btn-primary" value="submit" name="submitbtn1">Update</button>
        <button type="button" id = "editstudentbtn" class="btn btn-primary" value="submit" name="editstudentbtn" hidden>Edit Details</button>
        <button type="button" id = "submitstudentbtn" class="btn btn-primary" value="submit" name="submitstudentbtn" hidden>Update</button>
...
<div class="container mt-3" id='formcontainer'>
  <h2>Registration Form</h2>
  <!-- <div style="text-align:right" id='logoutbtn'> </div> -->
  <div style='text-align:center' id='editstudentmessage' class='text-success'></div>
